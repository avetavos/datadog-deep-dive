...
**Logging without Limits** หมายถึง ingestion กับ indexing ถูกแยกออกจากกัน — **log-based metric** (COUNT หรือ DISTRIBUTION, 10-second granularity, 15 เดือน) และ **Log Archive** (cloud storage ราคาถูกของคุณเอง) ทั้งคู่ดึงข้อมูลจาก ingest stream เต็ม ๆ ไม่ว่า Exclusion Filter ของ index จะเป็นยังไง และ **Rehydration** ให้คุณ re-index ชิ้นส่วนของ archive ที่ scope ด้วยเวลาชั่วคราว เมื่อต้องการค้นหาอีกครั้ง
</Callout>
